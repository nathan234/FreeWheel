...
object BegodeModelCatalog {
    ...
    private val entries = listOf(
        ...
        entry("Hero C30", 100.8, lowVoltageV = 79.0, emptyVoltageV = 78.0, noLoadSpeedKmh = 97.0, firmwareSignatures = gwCf("20022")),
        entry("Hero C38", 100.8, lowVoltageV = 79.0, emptyVoltageV = 78.0, noLoadSpeedKmh = 79.0, firmwareSignatures = gwCf("20122")),
        ...
        entry("Monster (84 V)", 84.0, "Monster 84V", noLoadSpeedKmh = 74.0),
        entry("Monster (100 V)", 100.8, "Monster 100V", emptyVoltageV = 78.0, noLoadSpeedKmh = 93.0),
        entry("Monster Pro", 100.8, emptyVoltageV = 72.0, noLoadSpeedKmh = 106.0, firmwareSignatures = gwCf("24020")),
        entry("Monster V2 (84 V)", 84.0, "Monster V2 84V", noLoadSpeedKmh = 74.0),
        entry("Monster V2 (100 V)", 100.8, "Monster V2 100V", noLoadSpeedKmh = 93.0),
        entry("Monster V3 (84 V)", 84.0, "Monster V3 84V", noLoadSpeedKmh = 74.0),
        entry("Monster V3 (100 V)", 100.8, "Monster V3 100V", noLoadSpeedKmh = 93.0),
        entry("Msuper X (84 V)", 84.0, "MSuper X 84V", noLoadSpeedKmh = 76.0, firmwareSignatures = gwCf("19310")),
        entry("Msuper X (100 V)", 100.8, "MSuper X 100V", noLoadSpeedKmh = 95.0, firmwareSignatures = gwCf("19320")),
        ...
        entry("Nikola", 84.0, noLoadSpeedKmh = 70.0),
        ...
        entry("Tesla (67 V)", 67.2, "Tesla 67V"),
        entry("Tesla (84 V)", 84.0, "Tesla 84V", noLoadSpeedKmh = 68.0),
        entry("Tesla 2", 84.0, noLoadSpeedKmh = 68.0),
